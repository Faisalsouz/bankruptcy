...
def get_model(neurons_first_layer, neurons_second_layer, neurons_third_layer, neurons_fourth_layer, optimizer, loss, metrics, input_shape):
    model = Sequential()
    model.add(Dense(neurons_first_layer, input_shape=input_shape))
    model.add(Dense(neurons_second_layer, input_shape=input_shape))
    model.add(Dense(neurons_third_layer, input_shape=input_shape))
    model.add(Dense(neurons_fourth_layer, input_shape=input_shape))
