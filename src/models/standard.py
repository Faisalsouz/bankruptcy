...
def cfg():
    ...
    activation_second_layer = 'sigmoid'
    neurons_first_layer = 4
    neurons_second_layer = 1
    optimizer = 'adam'
...
def get_model(activation_first_layer, activation_second_layer, neurons_first_layer, neurons_second_layer, optimizer, loss, metrics, input_shape):
    model = Sequential([
        Dense(neurons_first_layer, activation=activation_first_layer, input_shape=input_shape),
